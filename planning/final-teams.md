...
| Guantanamo Bay Wendy's | Evan Birnbaum · Derin Sezgin · Magnes Dugan · Oliver Chung | **Fixr Findr** | **sustainability & transparency** | **The Sustainability & Transparency Team** |
...
- **Guantanamo Bay Wendy's** (Fixr Findr) states its value — **sustainability & transparency** — in the ethical-reflection section, not the value field. **`oc233-1` = Oliver Chung** (now on this team).
