...
**Deliverable → `planning-report.md`** (value, beneficiary, persona + need evidence, operationalization, storyboard, scope). Due end of Wednesday. *Open the day with **Remy Stewart's Figma guest talk**, then a short planning lecture (personas + storyboards, with and without AI), then plan.*
