# replit.md — Ethical Vibe Coding (TECHIE 1121)

Instructions for the **Replit Agent** in this repository. The full canonical
version is in [AGENTS.md](AGENTS.md) — follow it too.
